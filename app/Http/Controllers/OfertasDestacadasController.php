...
class OfertasDestacadasController extends Controller
{
    //
    public function ofertas(Request $request)
    {
        ...
        if ($cantTotal >= $cantOfertasPorPagina) {

            $ofertasFiltradas = $ofertas->random($cantOfertasPorPagina)->toArray();
        } else {
    ...
    private function filtrarOfertas(Request $request)
    {
        ...
        $ofertas = $ofertas->sortByDesc('ACTUALIZADO_EN');
